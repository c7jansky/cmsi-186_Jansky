...
import java.math.BigInteger;
 ...
 public class BrobIntTester {
   ...
   public static void main( String[] args ) {
      ...
      catch( Exception e ) { System.out.println( "        Exception thrown: Could not make string  " ); }
      try {
      ...
      catch( Exception e ) { System.out.println( "        Exception thrown: Could not compare values given " ); }
      ...
      catch( Exception e ) { System.out.println( "        Exception thrown: Could not create valid object  " ); }
      ...
      catch( Exception e ) { System.out.println( "        Exception thrown: Could compare values given  " ); }
      ...
      catch( Exception e ) { System.out.println( "        Exception thrown: Could not create long  " ); }
    ...
    */
      ...
      catch( Exception e ) { System.out.println( "        Exception thrown: could not create object " ); }

      try {
         System.out.println( "      expecting: 10\n" +
                             "        and got: " + g11.toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not convert object to a string  " ); }
      ...
      try {
         ...
         System.out.println( "      expecting: 30 and got " + g11.plus( g12 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not add objects  " ); }
      ...
      catch( Exception e ) { System.out.println( "        Exception thrown: could not make object string  " ); }

      try {
         System.out.println( "    Test " + df.format( testNumber++ ) + ": Adding g11 and g13 [10 + 234567]: " );
         System.out.println( "      expecting: 234577 and got " + g11.plus( g13 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not add objects  " ); }

      try {
         System.out.println( "    Test " + df.format( testNumber++ ) + ": Adding g13 and g11 [234567 + 10]: " );
         System.out.println( "      expecting: 234577 and got " + g13.plus( g11 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not add objects  " ); }
      ...
      catch( Exception e ) { System.out.println( "        Exception thrown: could not convert object string " ); }
      ...
      try {
         ...
         System.out.println( "      expecting: -234577 and got " + g14.plus( g15 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not add objects " ); }

      try {
         System.out.println( "    Test " + df.format( testNumber++ ) + ": Adding g15 and g14 [-10 + -234567]: " );
         System.out.println( "      expecting: -234577 and got " + g15.plus( g14 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not add objects  " ); }
      ...
      catch( Exception e ) { System.out.println( "        Exception thrown: could not convert object to string " ); }

      try {
         System.out.println( "    Test " + df.format( testNumber++ ) + ": Adding g14 and g16 [-234567 + -999999]: " );
         System.out.println( "      expecting: -1234566 and got " + g14.plus( g16 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not add objects  " ); }

      try {
         System.out.println( "    Test " + df.format( testNumber++ ) + ": Adding g16 and g14 [-999999 + -234567]: " );
         System.out.println( "      expecting: -1234566 and got " + g16.plus( g14 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not add objects " ); }
     ...
     // added note which needs to be taken care of in the next iteration....
      ...
      try {
         ...
         System.out.println( "      expecting: 0 and got: " + g1.compare( g2 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber++ ) + ": Checking compareTo() method on g2.compareTo g1: "  );
         System.out.println( "      expecting: 0 and got: " + g2.compare( g1 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber++ ) + ": Checking compareTo() method on g1.compareTo g3: "  );
         System.out.println( "      expecting: positive value and got: " + g1.compare( g3 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber++ ) + ": Checking compareTo() method on g3.compareTo g1: "  );
         System.out.println( "      expecting: negative value and got: " + g3.compare( g1 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber ) + ": Checking compareTo() method on g3.compareTo g4: "  );
         System.out.println( "      expecting: positive value and got: " + g3.compare( g4 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber ) + "a: Checking compareTo() method on 123456789.compareTo 234: "  );
         System.out.println( "      expecting: positive value and got: " + (new BrobInt("123456789").compare( new BrobInt("234"))) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber ) + "b: Checking compareTo() method on 123.compareTo 123456789: "  );
         System.out.println( "      expecting: ngative value and got: " + (new BrobInt("123").compare( new BrobInt("123456789"))) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber ) + "c: Checking compareTo() method on g3.compareTo 999: "  );
         System.out.println( "      expecting: positive value and got: " + g3.compare( new BrobInt( "999" ) ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber ) + "d: Checking compareTo() method on 1234.compareTo -999: "  );
         System.out.println( "      expecting: positive value and got: " + (new BrobInt("1234").compare( new BrobInt( "-999" ) ) ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber++ ) + "e: Checking compareTo() method on -999.compareTo G3: "  );
         System.out.println( "      expecting: negative value and got: " + new BrobInt( "-999" ).compare( g3 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber++ ) + "f: Checking compareTo() method on 00234.compareTo 234: "  );
         System.out.println( "      expecting: zero value and got: " + new BrobInt( "00234" ).compare( new BrobInt( "234" ) ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber++ ) + "f: Checking compareTo() method on -23456.compareTo -234: "  );
         System.out.println( "      expecting: negative value and got: " + new BrobInt( "-23456" ).compare( new BrobInt( "-234" ) ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber++ ) + "f: Checking compareTo() method on -234.compareTo -23456: "  );
         System.out.println( "      expecting: positive value and got: " + new BrobInt( "-234" ).compare( new BrobInt( "-23456" ) ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }

      try {
         System.out.println( "\n    Test " + df.format( testNumber++ ) + "f: Checking compareTo() method on -100000.compareTo -100001: "  );
         System.out.println( "      expecting: positive value and got: " + new BrobInt( "-100000" ).compare( new BrobInt( "-100001" ) ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not compare objects " ); }
      ...
      catch( Exception e ) { System.out.println( "        Exception thrown: could not create object and convert to string " ); }
      ...
      try {
         System.out.println( "      expecting: 43238372915913199204527729450732254954851885232694621\n" +
                             "        and got: " + g4.multipliedBy( new BrobInt( "3" ) ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not multiply objects " + e.toString() ); }
      ...
      try {
         System.out.println( "      expecting: 248498499\n" +
                             "        and got: " + new BrobInt("82832833").multipliedBy( new BrobInt( "3" ) ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: could not multiply objects " + e.toString() ); }
...
//      catch( Exception e ) { System.out.println( "        Exception thrown:  " + e.toString() ); }
      ...
      try {
         System.out.println( "      expecting: 26\n" +
                             "        and got: " + fiftytwo.dividedBy( BrobInt.TWO ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: Could not divide objects " + e.toString() ); }
...
//      catch( Exception e ) { System.out.println( "        Exception thrown: Could not divide objects " + e.toString() ); }
      ...
      try {
         System.out.println( "      expecting: 6\n" +
                             "        and got: " + g17.modulus( g18 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: Could not modulus objects " + e.toString() ); }

      System.out.println( "\n    Test " + df.format( testNumber++ ) + ": Modding g19 by g20 [56789 % 37]: " );
      try {
         System.out.println( "      expecting: 31\n" +
                             "        and got: " + g19.modulus( g20 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown: Could not modulus objects " + e.toString() ); }
