...
echo ============================================================================   >> testresults.txt
REM @java SkateRamp poly -3.0 -7.0 -1.0 -2.0 0.0 1.0 0.0 2.0 1e-6%%                     >> testresults.txt
...
echo ============================================================================   >> testresults.txt
REM @java SkateRamp sin -17.0 3.0 -11.0 11.0 1e-7%%                                     >> testresults.txt
...
echo ============================================================================   >> testresults.txt
REM @java SkateRamp sin -17.0 1.0 -23.0 23.0 1e-4%%                                     >> testresults.txt
