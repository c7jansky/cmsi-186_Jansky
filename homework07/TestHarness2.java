...
public class TestHarness {
    ...
    public static String TestHarness(String O){
        ...
        //String O = "useless";
            ...
            System.out.println("GENERATING 30 RANDOM DIGITS FROM 1-1,000 FOR ARGS[0] AND 1-100,000 FOR ARGS[1]");
            ...
            while (i < 30) {
                ...
                int RandInt1 = (int)(Math.random() * (999 - 1 + 1) + 1);
                
                int RandInt2 = (int)(Math.random() * (99999 - 1 + 1) + 1);
